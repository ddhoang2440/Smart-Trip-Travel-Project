...
const ShopCart = () => {
  ...
  useEffect(() => {
    if (appliedVoucher) {
      if (
        appliedVoucher.min_order_value &&
        subTotal < appliedVoucher.min_order_value
      ) {
  ...
  const handleApplyVoucher = async () => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        let msg = `Áp dụng thành công! Giảm ${voucher.discount}${
  ...
  return (
    <>
      <div className="">
        ...
        />
        <div className="py-4 px-[6vw] lg:px-[10vw] bg-white">
          ...
          <div className="flex flex-col  lg:flex-row gap-16 lg:gap-4 justify-between mt-[8vh] ">
            <div className="space-y-8 w-[90vw]  lg:w-[45%]  ">
              ...
              <div className="bg-white shadow-gray px-6 py-5 flex flex-col gap-6 h-[20vh] ">
                ...
                {appliedVoucher && (
                  <div
                    className={`mt-2 text-sm p-3 border rounded-lg ${
                      appliedVoucher.min_order_value &&
                      subTotal < appliedVoucher.min_order_value
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-xs mt-1">
                          ...
                          {appliedVoucher.type === "PERCENT" ? "%" : "đ"}
                          {appliedVoucher.min_order_value > 0 &&
                            ` • Đơn từ ${formatPrice(
                              appliedVoucher.min_order_value
                            )}đ`}
                        </p>
                        ...
                        {appliedVoucher.min_order_value &&
                          subTotal < appliedVoucher.min_order_value && (
                            <p className="text-xs font-bold mt-1">
                              ⚠️ Mua thêm{" "}
                              {formatPrice(
                                appliedVoucher.min_order_value - subTotal
                              )}
                              đ để dùng mã
                            </p>
                          )}
