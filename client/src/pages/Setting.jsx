        ...
        return (
          <div className="space-y-6">
            ...
            <div>
              ...
              <select className="border cursor-pointer border-gray-300 px-3 py-2 rounded-md focus:ring-2">
            ...
            <button className="py-3 px-4 cursor-pointer border bg-amber-400 text-white rounded-3xl hover:bg-amber-500 transition">
              Lưu thay đổi
            </button>
          </div>
        );
