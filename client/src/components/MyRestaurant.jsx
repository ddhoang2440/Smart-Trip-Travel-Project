...
import { filterRestaurantMenu, getUserMenu, removeMenu } from "../contexts/MenuRedux";
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap flex items-center justify-center">
                    <div className="flex gap-2 ">
                      ...
                      <button onClick={() => handleRemoveMenu(item._id)} className="px-3 py-1 bg-red-500 text-white rounded-lg hover:bg-red-600 text-sm transition-colors">
                        Xóa
                      </button>
                    </div>
                  </td>
                ...
                >
                  ...
                  <div className="flex flex-row gap-1 rounded-xl" >
                  {
                    review?.images?.map((item, idx) => (
                      <img src={item} className="w-[22vw] h-[14vw]" alt="" key={review._id + idx}/>
                    ))
                    }
                    </div>
                </div>
                    ...
                    <div className="hidden lg:block w-[12vw] text-center font-semibold text-green-700">
                      {item.status === "Confirmed" ? (
                        <div className="flex flex-col gap-2">
                          <p>Đã Xác Nhận</p>
                          <button className="btn btn-soft btn-neutral rounded-full">
                            Hoàn Thành Đơn Hàng
                          </button>
                        </div>
                      ) : (
