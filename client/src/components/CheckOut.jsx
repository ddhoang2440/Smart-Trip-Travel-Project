        ...
        >
          ...
          <div className="flex lg:flex-row flex-col justify-between gap-4">
            <button
              type="button"
              onClick={() => setCheck(false)}
              className="flex gap-2 items-center justify-center shadow-xl transition-all duration-500 py-3 px-2 bg-gray-300/40 hover:bg-black/70 p w-full lg:w-1/2 text-center hover:text-white"
            >
