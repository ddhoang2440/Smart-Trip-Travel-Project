import { IconBuildingStore, IconDeviceMobile, IconMapPin, IconShoppingCartDollar, IconX } from '@tabler/icons-react';
...
const RestaurantAdd = () => {
  ...
  return (
    <div>
      <form onSubmit={(e) => handleSubmit(e)} className="w-full px-10 space-y-3">
        ...
        <input type='file' multiple onChange={(e) => handleImageChange(e) } className='file-input w-full file-input-neutral' />
  
        <button type='submit' className="btn btn-soft btn-neutral w-full">Add</button>
      </form>
    </div>
  );
}
