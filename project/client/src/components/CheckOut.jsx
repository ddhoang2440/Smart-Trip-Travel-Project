...
export const CheckOut = ({ check, setCheck, setEmail, setUser, setAddress, setContact, user, email, address, contact, handleShipping }) => {
  return (
    check && (
      <div
      ...
      >
        ...
        >
          ...
          <input type="text" value={user} onChange={(e) => setUser(e.target.value)} className="input input-lg w-full" />
          ...
          <div className="flex lg:flex-row flex-col justify-between gap-4">
            ...
            className="flex gap-2 items-center w-full lg:w-1/2 justify-center shadow-lg shadow-warning/40 bg-warning/70 text-black py-3 px-2 p hover:bg-warning transition-all duration-500 hover:text-white "
            >
