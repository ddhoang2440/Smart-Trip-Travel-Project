...
from routes import user_route, restaurant_route, menu_route, comment_route, voucher_route, order_route, contact_route, search_route, recommendation_route, history_route
import uvicorn
